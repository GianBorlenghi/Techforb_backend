...
public class User implements UserDetails,Serializable {
	...
	*/
	...
	public User(Long id_user, @NotBlank String password, @NotBlank String name,
			@NotBlank String surname, @Past Date date_of_birth, @Email @NotBlank String username, @NotBlank String province,
